...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $query = mysqli_query($koneksi, "INSERT INTO data_karyawan VALUES ('','$nama','$tempat_tanggal_lahir','$jenis_kelamin','$alamat','$email','$posisi')");
  if ($query) {
    echo "berhasil";
  }
}
    ...
    <div class="row">
      ...
      <form action="" method="post">
        ...
        <div class="mb-3">
          ...
          <input type="text" id="tempat_tanggal_lahir" name="tempat_tanggal_lahir" class="form-control">
        </div>
        <div class="mb-3">
